...
def get_pendulum_random_state(
    ...
    theta_dot_init = np.random.uniform(theta_dot_init_min, theta_dot_init_max)
    return np.array([x_init, theta_init, x_dot_init, theta_dot_init])
...
def get_pendulum_down_state(
    ...
    # Pendulum down state either {-pi, pi} +/- delta_theta
